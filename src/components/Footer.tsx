  ...
  return (
    <div className='w-[100%] h-[10vh]'>
      <div className="px-4  pt-4 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8">
        <div className=" flex justify-center gap-10 row-gap-6 mb-8 items-center sm:grid-cols-2 lg:grid-cols-4">
          {/* <div className="sm:col-span-2">
            <a href="/" className="inline-flex items-center">
              <img src={logo} className='h-20' alt="logo"/>
            </a>
            <div className="text-justify lg:max-w-sm">
              <p className="text-sm black">
                يقدم موقعنا حلاً ذكياً لتنظيم مشاويرك باستخدام خرائط قوقل,  من خلال إدخال المشاوير وتحديد الأوقات المشغولة،يقوم الموقع بجدولة مثالية تضمن أقل مسافة وأفضل توقيت لكل مشوار.
              </p>
            </div>
          </div> */}
          <div className='pt-6 grid grid-rows-2 text-center'>
            <span className="text-3xl font-bold tracking-wide text-[#9685CF]">تواصل معنا</span>
            <div className="flex mt-2 mr-1 gap-4">
              ...
              <a href="#" className="text-gray-700 hover:text-gray-900">
                <svg fill="#000000" height="40px" width="40px" viewBox="0 0 216 216">
                  <path d="M108,0C48.353,0,0,48.353,0,108s48.353,108,108,108s108-48.353,108-108S167.647,0,108,0z M156.657,60L107.96,98.498 L57.679,60H156.657z M161.667,156h-109V76.259l50.244,38.11c1.347,1.03,3.34,1.545,4.947,1.545c1.645,0,3.073-0.54,4.435-1.616 l49.374-39.276V156z"/>
                </svg>
              </a>
              <a href="https://www.instagram.com/jdwlha" target='_blank' rel='noopener noreferrer' className="text-black transition-colors duration-300 hover:text-deep-purple-accent-400">
                <svg viewBox="0 0 30 30" fill="currentColor" width="40px" height="40px">
        ...
        <div className="flex flex-col-reverse justify-center pt-5 pb-10 border-t lg:flex-row">
          <p className="text-lg max-sm:text-center font-bold text-[#9685CF]">
